<?php $ma_variable = "variable"; // Déclarer les variables en dehors du HTML ?>
<!DOCTYPE html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="http://phppartie1ex1.info/index.php">Exercice 1
...
<body>
  ...
  <!-- Début de l'exercice  -->
  <p><?= $ma_variable  // Mettre le PHP dans une balise HTML?></p>
  <!-- Fin de l'exercice -->
